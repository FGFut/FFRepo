...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Administrador\Desktop\Trabalho DS(Vs code )\Trab Ds\Fgfut\v'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Administrador\Desktop\Trabalho DS(Vs code )\Trab Ds\Fgfut\v\Scripts\deactivate.nu'
